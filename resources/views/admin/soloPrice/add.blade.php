...
<!-- Modal -->
<div class="modal fade" id="soloprice-dialog" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{ URL::to('admin/solo_price/store') }}" method="POST" role="form" id="soloprice-form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="alert alert-danger" id="soloprice-error" style="display: none;">
                                <ul>
